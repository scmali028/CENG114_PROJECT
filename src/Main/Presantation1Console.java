...
public class Presantation1Console {
   ...
   /* private static Scanner input = new Scanner(System.in);
    private static ArrayList<AllWords> LengthOfWords = new ArrayList<>();// gameFrasmede yükle  direk yükleyelim aradan çıksın 
...
/*
    public static void mainMenu() throws IOException {
      ...
      //  RegisterAndLoginMenu();
       ...
       // createPlayer();yapıldı
        // loadCategories(); yüklendi
      //  boolean exit = false;// bu direl oyundan çıkış şerysi
        // bu eleamn benim framdeki akışım olucak 
       // for (int questionIndex = 0; questionIndex <= 6 && !exit; questionIndex++) {

            String randomWord = LengthOfWords.get(questionIndex).getRandomWord().toLowerCase();// text areadaki answerım olcak
