...
import Hangman.Admin;
import Hangman.NormalPlayer;
...
public class Presantation1Console {
    ...
    private static RegisterAndSignIn registerAndSignIn;
    ...
    public static void mainMenu() throws IOException   { 
        ...
        for (int questionIndex = 0; questionIndex <= 3 && !exit; questionIndex++) {
         ...
         System.out.println("congrats The game finished");
        System.out.println(normalPlayer.toString());
        
        System.out.println("scorun submitlendi");
        Submit sb=new Submit(normalPlayer);
        
        sb.writeOnScoreboard();
        
        System.out.println("do you wanna burda play again -> ana menüye gitme butonu olcak ");
        System.out.println("do you wanna add question(burda ekledim diyo varsay)\n\n");
        AddQuestionFromUser.addQuestion(normalPlayer.getId(), input);
        
        
        mainMenu();// main menü butonu bu öyle düşün
   ...
   public static void RegisterAndLoginMenu() throws IOException {
    ...
    public static void createPlayer() throws IOException {
        ...
        normalPlayer = new NormalPlayer(
                ...
                // oyuncu adı
                "",
                ReaderAndWriterFileProcess.getterLastIdFromFile() , // ilk answer bo
